...
/**
 * The {@link ViessmannAuthBridge} performs the initial OAuth authorization
 * with the Viessmann authorization servers.
 *
 * @author Ronny Grun - Initial contribution
 */
@NonNullByDefault
public class ViessmannAuthBridge {

    private final Logger logger = LoggerFactory.getLogger(ViessmannAuthBridge.class);

    private final ViessmannBridgeHandler bridgeHandler;
    private final ViessmannApiBridge api;
    ...
    public ViessmannAuthBridge(ViessmannApiBridge api, ViessmannBridgeHandler bridgeHandler, String apiKey,
