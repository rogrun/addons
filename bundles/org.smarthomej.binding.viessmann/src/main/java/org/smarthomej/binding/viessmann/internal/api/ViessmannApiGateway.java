...
import static org.smarthomej.binding.viessmann.internal.ViessmannBindingConstants.API_TIMEOUT_MS;
import static org.smarthomej.binding.viessmann.internal.ViessmannBindingConstants.VIESSMANN_BASE_URL;
...
/**
 * The {@link ViessmannApiGateway} is responsible for managing all communication with
 * the Viessmann API service.
 *
 * @author Ronny Grun - Initial contribution
 */
@NonNullByDefault
public class ViessmannApiGateway {
    ...
    private final Logger logger = LoggerFactory.getLogger(ViessmannApiGateway.class);
    ...
    private @NonNullByDefault({}) ViessmannAuthGateway viessmannAuth;

    public ViessmannApiGateway(final ViessmannGatewayHandler bridgeHandler, final String apiKey, HttpClient httpClient,
    ...
    public void createOAuthClientService() {
        ...
        viessmannAuth = new ViessmannAuthGateway(this, bridgeHandler, apiKey, httpClient, user, password, callbackUrl);
    }
    ...
    private void setInstallationAndGatewayId() {
        try {
            ...
            if (installation != null) {
                ...
                logger.debug("Gateway Serial : {}", gatewaySerial);

                this.installationId = data.id.toString();
                this.gatewaySerial = gatewaySerial;
                bridgeHandler.setInstallationGatewayId(data.id.toString(), gatewaySerial);
            }
