...
public class AquatempDiscoveryService extends AbstractDiscoveryService implements ThingHandlerService {
    ...
    private @Nullable AquatempBridgeHandler bridgeHandler;
    ...
    public void setThingHandler(ThingHandler thingHandler) {
        if (thingHandler instanceof AquatempBridgeHandler) {
            this.bridgeHandler = (AquatempBridgeHandler) thingHandler;
    ...
    protected void startScan() {
        AquatempBridgeHandler bridgeHandler = this.bridgeHandler;
    ...
    private void buildDiscoveryResult(String address) {
        ...
        AquatempBridgeHandler bridge = bridgeHandler;
        if (bridge == null) {
            logger.warn("BridgeHandle is not set but a discovery result has been produced. This should not happen.");
            return;
        }
